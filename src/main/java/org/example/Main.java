...
public class Main {
    ...
    public static void main(String[] args) throws LoginException, InterruptedException {
        ...
        String serverId = tokens.serverId;
        ...
        jda.getGuildById(serverId).upsertCommand("paranoia", "sends a paranoia question!").queue();
        jda.getGuildById(serverId).upsertCommand("neverhaveiever", "sends a never have I ever question!").queue();
